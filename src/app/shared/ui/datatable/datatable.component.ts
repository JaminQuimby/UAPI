...
export class DatatableComponent implements OnInit {
  ...
  render() {
    ...
    if (!toolbar) {
      element.parent().find(".dt-toolbar").append('<div class="text-right"><img src="assets/img/logo.png" alt="uapi" style="width: 111px; margin-top: 3px; margin-right: 10px;"></div>');
    }
